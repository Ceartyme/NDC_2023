...
class Jeu():
    ...
    def recevoir_attaque(self):
        for proj in self.liste_projectile:
            if proj.num==0:
                if self.liste_perso[1].pos_x <=proj.pos_x+8<=self.liste_perso[1].pos_x+16 or self.liste_perso[1].pos_x <=proj.pos_x<=self.liste_perso[1].pos_x+16:
                    if self.liste_perso[1].pos_y+16>=proj.pos_y>=self.liste_perso[1].pos_y:
                        self.liste_projectile.remove(proj)
                        self.liste_perso[1].vie-=self.liste_perso[0].dist

            if proj.num==1:
                if self.liste_perso[0].pos_x <=proj.pos_x+8<=self.liste_perso[0].pos_x+16 or self.liste_perso[0].pos_x <=proj.pos_x<=self.liste_perso[0].pos_x+16:
    ...
    def update(self):
        ...
        elif self.perso_choisi==False and self.partie_finie==False:
            self.choisir()
        elif self.perso_choisi==True and self.partie_finie==False:
            for perso in self.liste_perso:
                perso.dessin()
    ...
    def draw(self):
        ...
        if self.demarre==False and self.regles==False:
        ...
        elif self.demarre==True and self.partie_finie==False:
            ...
            elif self.demarre==True and self.perso_choisi==True and self.partie_finie==False:
            ...
            pyxel.text(10,110,"'R' to restart",4)
